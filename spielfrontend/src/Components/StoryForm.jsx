  ...
  render() { 
    return ( 
      <div class = "card container-xxl"> 
        ...
        <div class="mb-3 mt-3">
      <label>Story:</label>
      <textarea class="form-control container-xxl" rows="7" id="comment" name= "story" onChange={this.handleChange} value={this.state.story}></textarea>
    </div>
      </form>
